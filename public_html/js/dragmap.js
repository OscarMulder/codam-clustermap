...
var $author$project$Main$Model = F5(
	function (dragmapModel, uploadHover, mapFile, hostlistFile, uploadFileList) {
		return {dragmapModel: dragmapModel, hostlistFile: hostlistFile, mapFile: mapFile, uploadFileList: uploadFileList, uploadHover: uploadHover};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	var model = A5($author$project$Main$Model, $elm$core$Maybe$Nothing, false, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, _List_Nil);
...
var $author$project$Dragmap$DragMsg = function (a) {
	return {$: 'DragMsg', a: a};
};
...
var $author$project$Dragmap$subscriptions = function (_v0) {
	var drag = _v0.drag;
	return A2($zaboco$elm_draggable$Draggable$subscriptions, $author$project$Dragmap$DragMsg, drag);
};
var $author$project$Main$subscriptions = function (_v0) {
	var dragmapModel = _v0.dragmapModel;
	if (dragmapModel.$ === 'Nothing') {
		return $elm$core$Platform$Sub$none;
	} else {
		var dmodel = dragmapModel.a;
		return A2(
			$elm$core$Platform$Sub$map,
			$author$project$Main$MapMsg,
			$author$project$Dragmap$subscriptions(dmodel));
	}
};
...
var $author$project$Asset$image = function (url) {
	return $author$project$Asset$Image(url);
};
var $elm$core$Platform$Cmd$map = _Platform_map;
var $author$project$Main$ReadJsonFile = function (a) {
	return {$: 'ReadJsonFile', a: a};
};
var $author$project$Main$ReadMapFile = function (a) {
	return {$: 'ReadMapFile', a: a};
};
var $elm$file$File$mime = _File_mime;
var $elm$file$File$toString = _File_toString;
var $elm$file$File$toUrl = _File_toUrl;
var $author$project$Main$readFile = function (file) {
	return ($elm$file$File$mime(file) === 'application/json') ? A2(
		$elm$core$Task$perform,
		$author$project$Main$ReadJsonFile,
		$elm$file$File$toString(file)) : (($elm$file$File$mime(file) === 'image/svg+xml') ? A2(
		$elm$core$Task$perform,
		$author$project$Main$ReadMapFile,
		$elm$file$File$toUrl(file)) : $elm$core$Platform$Cmd$none);
};
var $author$project$Dragmap$MapSettings = F4(
...
var $author$project$Dragmap$hostDecoder = A3(
...
var $author$project$Dragmap$hostListDecoder = $elm$json$Json$Decode$list($author$project$Dragmap$hostDecoder);
var $author$project$Dragmap$mapSettingsDecoder = A3(
	$webbhuset$elm_json_decode$Json$Decode$Field$require,
	'heigth',
	$elm$json$Json$Decode$int,
	function (height) {
		return A3(
			...
			function (width) {
				return A3(
					...
					'active-size',
					$elm$json$Json$Decode$int,
					function (activeIconSize) {
						return A3(
							$webbhuset$elm_json_decode$Json$Decode$Field$require,
							'empty-size',
							$elm$json$Json$Decode$int,
							function (emptyIconSize) {
								return $elm$json$Json$Decode$succeed(
									{activeIconSize: activeIconSize, emptyIconSize: emptyIconSize, height: height, width: width});
							});
					});
			});
	});
...
var $author$project$Dragmap$getHosts = function (hostfile) {
	var result = A2($elm$json$Json$Decode$decodeString, $author$project$Dragmap$hostModelDecoder, hostfile);
	if (result.$ === 'Ok') {
...
var $author$project$Dragmap$allHosts = function (_v0) {
	...
	return A2(
		...
		A2(
			$elm$core$Maybe$map,
			function (a) {
				return A2($elm$core$List$cons, a, hostList);
			},
			movingHost));
};
...
var $author$project$Dragmap$hostConverter = function (host) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'hostname',
				$elm$json$Json$Encode$string(host.id)),
				_Utils_Tuple2(
				'left',
				$elm$json$Json$Encode$int(host.position.a)),
				_Utils_Tuple2(
				'top',
				$elm$json$Json$Encode$int(host.position.b))
			]));
};
...
var $author$project$Dragmap$dragActiveBy = F2(
	function (delta, group) {
		return _Utils_update(
			group,
			{
				movingHost: A2(
					$elm$core$Maybe$map,
					$author$project$Dragmap$dragHostBy(delta),
					group.movingHost)
			});
	});
var $author$project$Dragmap$OnDragBy = function (a) {
	return {$: 'OnDragBy', a: a};
};
var $author$project$Dragmap$StartDragging = function (a) {
	return {$: 'StartDragging', a: a};
};
var $author$project$Dragmap$StopDragging = {$: 'StopDragging'};
...
var $author$project$Dragmap$dragConfig = $zaboco$elm_draggable$Draggable$customConfig(
	_List_fromArray(
		[
			$zaboco$elm_draggable$Draggable$Events$onDragBy($author$project$Dragmap$OnDragBy),
			$zaboco$elm_draggable$Draggable$Events$onDragStart($author$project$Dragmap$StartDragging),
			$zaboco$elm_draggable$Draggable$Events$onDragEnd($author$project$Dragmap$StopDragging)
		]));
...
var $author$project$Dragmap$startDragging = F2(
	function (id, hostmodel) {
		...
		return _Utils_update(
			...
			{
				hostList: others,
				movingHost: $elm$core$List$head(targetAsList)
			});
	});
var $author$project$Dragmap$stopDragging = function (hostmodel) {
	return _Utils_update(
		hostmodel,
		{
			hostList: $author$project$Dragmap$allHosts(hostmodel),
			movingHost: $elm$core$Maybe$Nothing
		});
};
...
var $author$project$Dragmap$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'DownloadJson':
				var hostlist = function () {
					...
					if (_v1.$ === 'Nothing') {
						...
						var hmodel = _v1.a;
						return $author$project$Dragmap$allHosts(hmodel);
					}
				}();
				return _Utils_Tuple2(
					model,
			...
			case 'PopoverMsg':
				...
				var updatePopState = function (session) {
					return A2($elm$core$String$contains, host, session.id) ? _Utils_update(
						session,
					...
					if (_v2.$ === 'Nothing') {
						...
						return $elm$core$Maybe$Just(
							_Utils_update(
								hmodel,
								{
									hostList: A2($elm$core$List$map, updatePopState, hmodel.hostList)
								}));
					}
				}();
				return _Utils_Tuple2(
			...
			default:
				var dragMsg = msg.a;
				return A3($zaboco$elm_draggable$Draggable$update, $author$project$Dragmap$dragConfig, dragMsg, model);
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UploadDragEnter':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{uploadHover: true}),
					$elm$core$Platform$Cmd$none);
			case 'UploadDragLeave':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{uploadHover: false}),
			...
			case 'GotFiles':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							uploadFileList: A2($elm$core$List$cons, file, files),
							uploadHover: false
						}),
					$author$project$Main$readFile(file));
			case 'ReadJsonFile':
				var hoststring = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							dragmapModel: A2(
								$author$project$Main$setDragModel,
								$elm$core$Maybe$Just(hoststring),
								model.mapFile),
							hostlistFile: $elm$core$Maybe$Just(hoststring)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ReadMapFile':
				var mapstring = msg.a;
					...
					_Utils_update(
						model,
						{
							dragmapModel: A2(
								...
								model.hostlistFile,
								$elm$core$Maybe$Just(
									$author$project$Asset$image(mapstring))),
							mapFile: $elm$core$Maybe$Just(
								$author$project$Asset$image(mapstring))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var mapmsg = msg.a;
				var _v1 = model.dragmapModel;
				if (_v1.$ === 'Just') {
					var dragmodel = _v1.a;
					var _v2 = A2($author$project$Dragmap$update, mapmsg, dragmodel);
					var newmodel = _v2.a;
					var newcmd = _v2.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								dragmapModel: $elm$core$Maybe$Just(newmodel)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$MapMsg, newcmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Dragmap$hostToId = function (host) {
	return A2(
		$elm$core$Maybe$withDefault,
		host,
		$elm$core$List$head(
...
var $rundis$elm_bootstrap$Bootstrap$Popover$top = function (_v0) {
	...
	return $rundis$elm_bootstrap$Bootstrap$Popover$Config(
		_Utils_update(
			conf,
			{direction: $rundis$elm_bootstrap$Bootstrap$Popover$Top}));
};
...
var $author$project$Dragmap$viewIcon = F2(
	function (model, host) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A2($zaboco$elm_draggable$Draggable$mouseTrigger, host.id, $author$project$Dragmap$DragMsg),
				...
				[
					...
					A3(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Dragmap$hostToId(host.id))
							]),
										...
										[
											...
											A2(
												...
												A2(
													...
													host.popState,
													$author$project$Dragmap$PopoverMsg(host.id))))
										]),
									_List_fromArray(
										[
											$author$project$Asset$emptyHost(model.mapSettings.emptyIconSize)
										]))))))
				]));
	});
	...
	function (model, hostmodel) {
		return A3(
			...
			A2(
				$elm$core$List$cons,
				_Utils_Tuple2(
					$author$project$Asset$toString(model.mapImage),
					A2(
						$elm$html$Html$img,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$style,
								'height',
								$elm$core$String$fromInt(model.mapSettings.height) + 'px'),
								A2(
								$elm$html$Html$Attributes$style,
								'width',
								$elm$core$String$fromInt(model.mapSettings.width) + 'px')
							]),
						_List_Nil)),
				A2($author$project$Dragmap$viewIcons, model, hostmodel)));
	});
var $author$project$Dragmap$view = function (model) {
	var _v0 = model.hostModel;
	if (_v0.$ === 'Nothing') {
		return A2(
			$elm$html$Html$p,
			_List_Nil,
		...
		var hostmodel = _v0.a;
		return A2($author$project$Dragmap$viewMap, model, hostmodel);
	}
};
var $author$project$Main$FilePick = {$: 'FilePick'};
var $author$project$Main$UploadDragEnter = {$: 'UploadDragEnter'};
var $author$project$Main$UploadDragLeave = {$: 'UploadDragLeave'};
...
var $author$project$Main$viewUploader = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				'dragenter',
				$elm$json$Json$Decode$succeed($author$project$Main$UploadDragEnter)),
				A2(
				$author$project$Main$hijackOn,
				'dragover',
				$elm$json$Json$Decode$succeed($author$project$Main$UploadDragEnter)),
				...
				$author$project$Main$hijackOn,
				'dragleave',
				$elm$json$Json$Decode$succeed($author$project$Main$UploadDragLeave)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$FilePick)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Upload Hostlist Json and Map svg')
					]))
			]));
};
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						function () {
						var _v0 = model.dragmapModel;
						if (_v0.$ === 'Just') {
							var dmModel = _v0.a;
							return A2(
								$elm$html$Html$map,
								$author$project$Main$MapMsg,
								$author$project$Dragmap$view(dmModel));
						} else {
							return A2(
								$elm$html$Html$p,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Please upload a host list in json format and a cluster map image in svg format.')
									]));
						}
					}()
					]))
